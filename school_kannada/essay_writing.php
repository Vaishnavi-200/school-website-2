...
<html class="no-js" lang="zxx">
   ...
   <head>
     <title>ವಿವಾ ಶಾಲೆ - ಪ್ರಬಂಧ ಬರವಣಿಗೆ</title>
         <?php 
                  ...
                  <div class="col-md-12">
                     <div class="it-breadcrumb-content z-index-3 text-center">
                        <div class="it-breadcrumb-title-box">
                           <h3 class="it-breadcrumb-title">ಪ್ರಬಂಧ ಬರವಣಿಗೆ
						   </h3>
                        </div>
               ...
               <div class="row">
                     ...
                     <div class="it-blog-item-box" data-background="assets/img/blog/bg-1.jpg">
                        <div class="it-blog-item">
                           <div class="it-blog-thumb fix">
                              <a href="#"><img src="../images/essay1.jpg" alt></a>
                           </div>
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                     <div class="it-blog-item-box" data-background="assets/img/blog/bg-1.jpg">
                        <div class="it-blog-item">
                           <div class="it-blog-thumb fix">
                              <a href="#"><img src="../images/essay2.jpg" alt></a>
                           </div>
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                     <div class="it-blog-item-box" data-background="assets/img/blog/bg-1.jpg">
                        <div class="it-blog-item">
                           <div class="it-blog-thumb fix">
                              <a href="#"><img src="../images/essay3.jpg" alt></a>
                           </div>
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-6 mb-30">
                     <div class="it-blog-item-box" data-background="assets/img/blog/bg-1.jpg">
                        <div class="it-blog-item">
                           <div class="it-blog-thumb fix">
                              <a href="#"><img src="../images/essay4.jpg" alt></a>
                           </div>
                        </div>
                     </div>
                  </div>
